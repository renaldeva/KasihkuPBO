...
namespace KasihkuPBO
{
    public partial class Form1 : Form
    {
        ...
        {
            string connString = "Host=localhost;Port=5432;Username=postgres;Password=fahrezaadam1784;Database=KASIHKU;";
            ...
            try
            {
                ...
                {
                    conn.Open();
                    string sql = "SELECT COUNT(*) FROM akun WHERE username = @user AND kata_sandi = @pass";
